...
<body>
	...
	<div class="container mt-5">
		...
		<div class="box">
			<h3>Show All Services</h3>
			<form action="<%=request.getContextPath()%>/GetAllServicesServlet">
				<div>
					<input type="submit" value="List All Services"
		...
		<div class="box">
			<h3>Add Service</h3>
			<form action="<%=request.getContextPath()%>/AddServiceServlet"
				method="POST">
				<div>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="<%=request.getContextPath()%>/admin/editService.jsp?id=<%=service.getId()%>"
						class="btn btn-primary btn-sm">Edit</a> <a
						href="<%=request.getContextPath()%>/DeleteServiceServlet?id=<%=service.getId()%>"
