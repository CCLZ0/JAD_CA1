...
<body>
    ...
    <div class="container mt-4">
        ...
        <% 
            ...
            try {
                manageConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/ca1?user=root&password=root123&serverTimezone=UTC");
        ...
        <% 
            ...
            if ("POST".equalsIgnoreCase(request.getMethod())) {
                ...
                try {
                    ...
                    manageConn2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/ca1?user=root&password=root123&serverTimezone=UTC");
